...
#region Convenience accessor properties
	...
	static public Texture alphaTexture
	{
		get { return Get<Texture>("NGUI Alpha Texture", null); }
		set { Set("NGUI Alpha Texture", value); }
	}
	...
	static public int atlasExtendPadding
	{
		get { return GetInt("NGUI Extend Padding", 2); }
		set { SetInt("NGUI Extend Padding", value); }
	}

	static public bool atlasAlphaSplit
	{
		get { return GetBool("NGUI Alpha Split", false); }
		set { SetBool("NGUI Alpha Split", value); }
	}
	...
	static public UIWidget AddEffect(GameObject go)
	{
		UIWidget w = NGUITools.AddWidget<UIEffect>(go);
		w.name = "Effect";
		w.pivot = pivot;
		w.width = 100;
		w.height = 100;
