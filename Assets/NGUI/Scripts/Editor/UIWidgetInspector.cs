...
public class UIWidgetInspector : UIRectEditor
{
	...
	protected override void DrawCustomProperties ()
	{
		if (NGUISettings.unifiedTransform)
		{
			...
			{
				DrawColor(serializedObject, mWidget, this);
			}
		}
		else DrawInspectorProperties(serializedObject, mWidget, true, this);
	}
	...
	public void DrawWidgetTransform () { DrawInspectorProperties(serializedObject, mWidget, false, this); }
	...
	/// <summary>
	/// Draw the widget's alpha.
	/// </summary>

	static public void DrawAlpha(SerializedObject so, UIWidget w)
	{
