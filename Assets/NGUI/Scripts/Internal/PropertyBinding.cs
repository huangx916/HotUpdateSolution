...
public class PropertyBinding : MonoBehaviour
{
	...
	void Awake()
	{
		if (update == UpdateCondition.OnEndOfFirstFrame && Application.isPlaying)
			StartCoroutine(DoEndOfFrame());
	}

	IEnumerator DoEndOfFrame()
	{
	...
	{
		UpdateTarget();
		if (update == UpdateCondition.OnStart && Application.isPlaying) enabled = false;
	}
