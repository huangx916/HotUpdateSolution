...
//    }
	...
	/// <summary>
	/// Helper function that returns whether the specified MonoBehaviour is opaque.
	/// </summary>

	[System.Diagnostics.DebuggerHidden]
	[System.Diagnostics.DebuggerStepThrough]
	static public bool IsOpaque(Behaviour mb)
	{
		if (mb && mb.enabled && mb.gameObject.activeInHierarchy)
		{
			UIRect rect = mb is UIRect ? mb as UIRect : mb.GetComponent<UIRect>();
			if (!rect || rect.alpha > 0)
			{
				return true;
			}
		}
	...
	/// <summary>
	/// Helper function that returns whether the specified GameObject is opaque.
	/// </summary>

	[System.Diagnostics.DebuggerHidden]
	[System.Diagnostics.DebuggerStepThrough]
	static public bool IsOpaque(GameObject go)
	{
		if (go && go.activeInHierarchy)
		{
			UIRect rect = go.GetComponent<UIRect>();
			if (!rect || rect.alpha > 0)
			{
				return true;
			}
