...
public class UIAtlas : MonoBehaviour
{
	...
	public int height
	{
		get
		{
			if (mReplacement != null)
			{
				return mReplacement.height;
			}
			if (mHeight > 0 || !texture)
			{
				return mHeight;
			}
	...
	/// <summary>
	/// Init size while texture is not compressed.
	/// </summary>

	public void InitSize(Texture tex)
	{
		mWidth = tex.width;
		mHeight = tex.height;
	}
