...
public abstract class UITweener : MonoBehaviour
{
	...
	/// <summary>
	/// Whether set value of "From" on enable.
	/// </summary>

	[HideInInspector]
	public bool SetBeginningOnEnable = false;

	/// <summary>
	/// Whether set value of "From" on awake.
	/// </summary>

	[HideInInspector]
	public bool setBeginningOnAwake = false;
	...
	/// <summary>
	/// Delay to enter curve in duration.
	/// </summary>

	[HideInInspector]
	public float curveDelayEnter = 0f;
	...
	/// <summary>
	/// Early to exit curve in duration.
	/// </summary>

	[HideInInspector]
	public float curveEarlyExit = 0f;
	...
	protected virtual void OnEnabled (GameObject go, bool enabled)
	{
		if (enabled)
		{
			if (SetBeginningOnEnable)
			{
				tweenFactor = 0;
				Sample(0, false);
			}
	...
	protected virtual void Start () {
		DoUpdate();
		UIEventListener.Get(gameObject).onEnabled = OnEnabled;
	...
	public void Sample (float factor, bool isFinished)
	{
		...
		float delayEnter = Mathf.Clamp01(curveDelayEnter / duration);
		float earlyExit = Mathf.Clamp01(curveEarlyExit / duration);
		float val = Mathf.Clamp01((Mathf.Clamp01(factor) - delayEnter) / (1 - delayEnter - earlyExit));
